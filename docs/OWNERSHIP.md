...
| `print`, `jsonValue`, `mustache` | Generate directly into the reserved draft without an intermediate allocated string; move the generated bytes once for publication. |
