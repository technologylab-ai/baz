...
Keep a [`web.mustache.Template`](https://technologylab-ai.github.io/baz/api/#baz.mustache.Template) in your App's `Shared` state. Initialize it before
...
[`mustache`](https://technologylab-ai.github.io/baz/api/#baz.mustache) selects one complete `text/html; charset=utf-8` response. The normal
...
render empty. Dynamic data can use the explicit [`web.mustache.Value`](https://technologylab-ai.github.io/baz/api/#baz.mustache.Value) type;
...
| [`App.response.body_bytes`](https://technologylab-ai.github.io/baz/api/#baz.ResponseLimits) | 8 KiB | Complete generated HTML body; the example also uses 8 KiB. |
...
[`Response.mustache`](https://technologylab-ai.github.io/baz/api/#baz.Response.mustache) generates directly into the unpublished reserved draft.
...
[`response.discard()`](https://technologylab-ai.github.io/baz/api/#baz.Response.discard) first if it also wants to clear draft headers.
...
the rollback guarantee of [`Response.mustache`](https://technologylab-ai.github.io/baz/api/#baz.Response.mustache).
