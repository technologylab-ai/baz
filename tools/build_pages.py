...
EXAMPLES = [
    ...
    ('tailscale_https', 'composition', 'HTTPS on your tailnet through tailscale serve: identity middleware, whoami, and resumable server-sent events.'),
...
def documents():
    paths = {'README.md', 'ROADMAP.md', 'LICENSE', '.zig-version', 'build.zig', 'build.zig.zon',
             ...
             'examples/assets/mustache.html', 'examples/assets/mustache-user.html', 'examples/assets/tailscale_https.html', 'examples/embedding/build.zig',
             ...
             'reports/2026-09-25-tailscale-https.md',
