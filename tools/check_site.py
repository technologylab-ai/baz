...
def check(output, documents, document_urls):
    ...
    assert len(re.findall(r'class="example-card"', index)) == 22
    ...
    print('Site checks passed: links, anchors, diagrams, 22 examples, four benchmark profiles, and document identity.')
