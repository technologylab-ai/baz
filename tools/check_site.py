...
def check(output, documents, document_urls):
    ...
    assert len(re.findall(r'class="example-card"', index)) == 23
    ...
    print('Site checks passed: links, anchors, diagrams, 23 examples, four benchmark profiles, and document identity.')
