...
The page uses [bounded/http](https://technologylab-ai.github.io/bounded-http/)’s visual language with Baz-specific narrative,
...
README and guides link both Baz’s site and [bounded/http](https://technologylab-ai.github.io/bounded-http/)’s repository/Pages site.
...
and the [bounded/http](https://technologylab-ai.github.io/bounded-http/) website link.
