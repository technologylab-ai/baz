...
| Scheduling/copy improvements | partial | Direct Linux operation cells and configurable batch1–64/global callback1–256 budgets are implemented and measured, retaining defaults 16/64. Both native ownership gates,48 paired operation-cell and24 same-binary B/Q trials passed; reports preserve ranges and memory growth. Remaining: output representation, I/O sharding, dynamic release/offload and combined-limit qualification. The independent architecture agent owns its separate worktree. |
