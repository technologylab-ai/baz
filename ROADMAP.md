...
| Scheduling/copy improvements | running | Direct Linux operation addressing passed both native gates and48 paired trials; its report is publishing from perf/direct-operation-cells. Batch/quantum implementation in perf/batch-quantum is source-complete; native gates and same-binary16/64 ×64/256 measurements pending. Defaults16/64 remain. Output representation and I/O sharding are separate experiments. |
